...
class TemplateCode(models.TextChoices):
    ...
    AGENT_IMP_LCL_DAP = "AGENT_IMP_LCL_DAP", "Agent Import LCL DAP Charge"
    AGENT_EXP_LCL_EXW = "AGENT_EXP_LCL_EXW", "Agent Export LCL EXW Charge"
    AGENT_EXP_AIR_EXW = "AGENT_EXP_AIR_EXW", "Agent Export Air EXW Charge"
